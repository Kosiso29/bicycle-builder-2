...
import { fetchModels, fetchCategories, fetchBrands, fetchPresets, fetchBuilds, fetchModelsPresets, fetchColorsPresets, fetchUsers, fetchColors, fetchAccessories, fetchAccessoryModels, fetchBuildsAndModelsBuilds } from "@/app/lib/data";
    ...
    return (
        <div className='max-w-full h-screen'>
            <form action={async () => {
                ...
                <Sidebar models={models} categories={categories} brands={brands} presets={presets} builds={builds} modelsPresets={modelsPresets} colorsPresets={colorsPresets} colors={colors} accessories={accessories} accessoryModels={accessoryModels} buildsAndModelsBuilds={buildsAndModelsBuilds} />
            </form>
