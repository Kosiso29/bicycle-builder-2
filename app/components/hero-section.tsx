...
export default function HeroSection() {
    return (
        <div className='flex items-center justify-between h-screen wrapper-padding text-white bg-[#1A1A1A]'>
            <div className='max-w-[42%]'>
                <h1 className='font-bold text-3xl text-gray-300'>CREATE YOUR</h1>
