...
export default function AdminBuilds() {
    ...
    useEffect(() => {
        const newTableBuilds = Object.entries(builds).filter((build: any) => build[1] !== "None").map((build: any) => {
            ...
            return [ build[1], filteredModelsPresets.map((filteredModelsPreset: any) => {
        ...
        console.log('builds newTableBuilds', newTableBuilds);
    ...
    return (
        <div>
            <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
                ...
                >
                    <span className="hidden md:block">Create Builds</span>{' '}
